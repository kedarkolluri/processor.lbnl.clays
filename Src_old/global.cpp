...
//{
	...
	int *nbr_ptr=NULL,*nbr_ptr1=NULL,*nbr_lst=NULL,*map=NULL,*map_full=NULL,*head=NULL,*list=NULL,mx,my,mz,ncell;
	...
	double rlst = 5.5; //hard coded cut off value of rlist -- need to change according to need
