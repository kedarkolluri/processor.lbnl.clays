...
#ifndef SINGLE_MAX_COORD
#define SINGLE_MAX_COORD 24
#endif

#ifndef MAX_COORD
#define MAX_COORD    MAX_ELEMS*SINGLE_MAX_COORD
#endif
...
typedef struct atomic_dat {
	...
	//int coord_info[MAX_ELEMS][SINGLE_MAX_COORD];
	double neigh_pe;
	int coord_agg[MAX_ELEMS];
